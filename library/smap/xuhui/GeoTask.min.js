! function (e, t) {
    ...
    "use strict";
    var e = (t.shqxboundary = "qx_boundary", t.shjdboundary = "jd_boundary", t.shjwhboundary = "jwh_boundary", t);

    function t() {}
    var d = (r.jsapi = "http://10.201.37.225:8080/smiapi/arcgis", r.jsapiversion4X = "4.15", r);
    ...
    function w(e) {
        ...
        return new n.Promise(function (e, t) {
            ...
            if (i) {
                ...
                o !== c ? t(new Error("The ArcGIS API for JavaScript is already loaded (" + o + ").")) : m() ? e(i) : y(i, e, t)
                ...
                r = c, (n = document.createElement("script")).type = "text/javascript", n.src = r, n.setAttribute("data-shsmi", "loading"), y(i = n, function () {
    ...
    var b = (x.prototype._addListener = function (e, t, r) {
    ...
    }, x.prototype.onceWrap = function (e, t) {
        function r() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    }, x.defaultMaxListeners = 50, x);

    function x() {
        this.events = new Map
    }
    var j = (I.prototype.S4 = function () {
        return (65536 * (1 + Math.random()) | 0).toString(16).substring(1)
    }, I.prototype.get_uuid = function () {
    ...
    var S, q, _ = (S = function (e, t) {
        ...
        P = (_(A, q = b), A.prototype.featureLayer = function (u) {
            return void 0 === u && (u = {}), k(this, void 0, void 0, function () {
                var a, t = this;
                return E(this, function (e) {
                    switch (e.label) {
                        case 0:
                            return a = null, [4, g(["esri/layers/GraphicsLayer", "esri/Graphic", "esri/layers/FeatureLayer"]).then(function (e) {
                                var o = e[0],
                                    s = e[1],
                                    n = e[2];
                                return k(t, void 0, void 0, function () {
                                    ...
                                    return E(this, function (e) {
                                        switch (e.label) {
                                            case 0:
                                                return this.view ? (u.layerUniqueId ? t = this.view.map.findLayerById(u.layerUniqueId) : u.queryurl && (t = new n({
                                                    url: u.queryurl
                                                })), t ? ((r = t.createQuery()).where = u.queryDefinition, r.outFields = void 0 === u.outFields ? ["*"] : u.outFields, [4, t.queryFeatures(r).then(function (e) {
                                                    if (0 < e.features.length) {
                                                        var r, n = i.view.map.findLayerById(i.displayedLayerid);
                                                        void 0 === n && (n = new o({
                                                            title: i.displayedLayerid + "查询结果",
                                                            id: i.displayedLayerid,
                                                            listMode: "hide"
                                                        }), i.view.map.add(n)), u.displayed && (u.symbol ? r = u.symbol : "polygon" === u.type ? r = {
                                                            type: "simple-fill",
                                                            color: [255, 255, 255, 0],
                                                            outline: {
                                                                color: [255, 0, 0, 1],
                                                            ...
                                                            e.geometry.spatialReference = i.view.spatialReference;
                                                            var t = new s({
                                                                geometry: e.geometry,
                        ...
                        case 1:
                            return e.sent(), [2, new n.Promise(function (e, t) {
                                e(a)
                            })]
                    }
                })
            })
        }, A.prototype.mapImageLayer = function (d) {
            return void 0 === d && (d = {}), k(this, void 0, void 0, function () {
                var c, t = this;
                return E(this, function (e) {
                    switch (e.label) {
                        case 0:
                            return c = null, [4, g(["esri/layers/GraphicsLayer", "esri/Graphic", "esri/tasks/QueryTask", "esri/tasks/support/Query"]).then(function (e) {
                                var s = e[0],
                                    a = e[1],
                                    u = e[2],
                                    l = e[3];
                                return k(t, void 0, void 0, function () {
                                    ...
                                    return E(this, function (e) {
                                        switch (e.label) {
                                            case 0:
                                                return d.layerUniqueId ? (r = this.view.map.findLayerById(d.layerUniqueId)) && (t = r.url) : t = d.queryurl, d.layerId ? (n = new u({
                                                    url: t + "/" + d.layerId
                                                }), (i = new l).returnGeometry = !0, i.outFields = void 0 === d.outFields ? ["*"] : d.outFields, [4, n.execute(i).then(function (e) {
                                                    if (0 < e.features.length) {
                                                        var r, n = o.view.map.findLayerById(o.displayedLayerid);
                                                        void 0 === n && (n = new s({
                                                            title: o.displayedLayerid + "查询结果",
                                                            id: o.displayedLayerid,
                                                            listMode: "hide"
                                                        }), o.view.map.add(n)), d.displayed && (d.symbol ? r = d.symbol : "polygon" === d.type ? r = {
                                                            type: "simple-fill",
                                                            color: [255, 255, 255, 0],
                                                            outline: {
                                                                color: [255, 0, 0, 1],
            ...
            return k(this, void 0, void 0, function () {
                var n = this;
                return E(this, function (e) {
                    return this.displayedLayerid = (new j).uuid, this.view = t, this.view.on("click", function (r) {

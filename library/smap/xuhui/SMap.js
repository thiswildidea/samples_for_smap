    ...
    Mapcofig.gisService = {
        ...
        baseMapServices: {
            ...
            layers: [{
                    ...
                    url: 'http://10.201.37.222/arcgis/rest/services/Hosted/basemap_dark/VectorTileServer',
        ...
        smapbussinessLayers: {
            ...
            layerGroups: [{
                    ...
                    layerGroups: [
                        {
                            ...
                            listMode: 'show',
                            layers: [{
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0403/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0404/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0407/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0408/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0410/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0411/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0412/MapServer",
                                    ...
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0413/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0414/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0415/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0416/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0417/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0418/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0419/MapServer",
                                ...
                                {
                                    url: "http://10.201.37.222/arcgis/rest/services/XHGQ_0420/MapServer",
                    ...
                    layers: [{
                            url: "http://10.201.37.222/arcgis/rest/services/XU_WG/FeatureServer",
                            id: "XH_WG",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XU_JD/FeatureServer",
                            id: "XH_JD",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XH_GNQ/FeatureServer",
                            id: "XH_GNQ",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: 'http://10.201.37.222/arcgis/rest/services/XH_GNQ2/FeatureServer',
                            id: 'XH_GNQ2',
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XH_ZDGNQ/FeatureServer",
                            id: "XH_ZDGNQ",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XH_ZJGD/MapServer",
                            id: "XH_ZJGD",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XH_JWH/FeatureServer",
                            id: "XH_JWH",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                            ...
                            url: "http://10.201.37.222/arcgis/rest/services/XH_XQ_Polygon/FeatureServer",
                            id: "XH_XQ_Polygon",
                            istoken: false,
                            visible: false,
                            opacity: 1.0,
                ...
                switch (layerOptions.layerType) {
                    ...
                    case 'FeatureLayer':
                        ...
                        if (layerOptions.layerdefinitionExpression) {
                            flayer.layerdefinitionExpression = layerOptions.layerdefinitionExpression;
                        }
                        view.map.add(flayer);
                        break;
                    case 'SceneLayer':
                        ...
                        if (layerOptions.layerdefinitionExpression) {
                            slayer.layerdefinitionExpression = layerOptions.layerdefinitionExpression;
                        }
                        view.map.add(slayer);
                        break;
                    case 'MapImageLayer':

        ...
        buildingsLayers: {
            ...
            layerGroups: [{
                    ...
                    layers: [{
                        ...
                        {
                            url: 'http://10.201.37.224/arcgis/rest/services/Hosted/xuhuibaimo/SceneServer',
                            id: 'model_white_zw',
                            isToken: false,
                            visible: true,
                            opacity: 1.0,
        ...
        smaplabel3d: {
            ...
            layerGroups: [{
                    ...
                    layerGroups: [{
                            ...
                            layers: [
                                {
                                    url: "http://10.201.37.224/arcgis/rest/services/POI_test1015/FeatureServer/0",
                                    id: "roadstreet",
                                    istoken: true,
                                    visible: true,
                                    opacity: 1.0,
                                ...
                                {
                                    url: "http://10.201.37.224/arcgis/rest/services/POI_test1015/FeatureServer/1",
                                    id: "sroad4000",
                                    istoken: true,
                                    visible: true,
                                    opacity: 1.0,
                                    ...
                                    url: "http://10.201.37.224/arcgis/rest/services/POI_test1015/FeatureServer/2",
                                    id: "xhpoi",
                                    istoken: true,
                                    visible: true,
                                    opacity: 1.0,
                                    ...
                                    url: "http://10.201.37.224/arcgis/rest/services/POI_test1015/FeatureServer/3",
                                    id: "residential",
                                    istoken: !0,
                                    visible: !0,
                                    opacity: 1,
                                    ...
                                    title: "小区标注",
                                    popupEnabled: !1,
                                    screenSizePerspectiveEnabled: !1,
...
var Map$1 = /** @class */ (function (_super) {
    ...
    Map.prototype.cameraTiltConstraint = function (ctilt) {
        var _this = this;
        if (this.view.type === '2d') {
            return;
        }
        if (ctilt) {
            load(['esri/core/watchUtils'])
                ...
                .then(function (_a) {
                var watchUtils = _a[0];
                var cameratiltConstraint = watchUtils.
                    init(_this.view, "camera.tilt", function (cameratilt) {
                    console.log(cameratilt);
                    if (cameratilt > ctilt) {
                        var camera = _this.view.camera.clone();
                        camera.tilt = ctilt;
                        _this.view.camera = camera;
                        // this.view.goTo({
                        //     center: this.view.center,
                        //     zoom: this.view.zoom,
                        //     tilt: ctilt,
                ...
                _this.watchHandles.push(['cameratiltConstraint', cameratiltConstraint]);
            });
        }
        else {
            var viewmodeHandles = this.watchHandles.filter(function (item) {
                return item[0] === 'cameratiltConstraint';
            });
                ...
                overlayers.forEach(function (overelement) {
                    if (overelement.overlaytype.toLowerCase() === 'marker') {
                        ...
                        var clientoperateLayer = new FeatureLayer({
                            ...
                            popupEnabled: false,
                            popupTemplate: false,
                            visible: overelement.visible,
                            maxScale: overelement.maxScale,
                            minScale: overelement.minScale,
    ...
    Map.prototype.addfeatureCluster = function (overlayers) {
        var _this = this;
        load(['esri/layers/esriClusterLayer', 'esri/layers/support/LabelClass', 'esri/Graphic', 'esri/geometry/Point', 'esri/symbols/PictureMarkerSymbol'])
            // tslint:disable-next-line:variable-name
            .then(function (_a) {
            var FeatureLayer = _a[0], LabelClass = _a[1], Graphic = _a[2], Point = _a[3], PictureMarkerSymbol = _a[4];
            if (overlayers instanceof Array) {
                overlayers.forEach(function (overelement) {
                    if (overelement.overlaytype.toLowerCase() === 'marker') {
                        var markrenderer = void 0;
                ...
                overlayers.datafiled.forEach(function (element) {
                    datafiled_5.push(element);
                });
                // const clusterImgSrc = (overlayers as OverlayGroup).style.clusterImgSrc;
                // const defaultClusterSym = (overlayers as OverlayGroup).style.defaultClusterSym;
                var clientoperateLayer_2 = new FeatureLayer({
                    id: overlayers.uuid,
                    title: overlayers.uuid,
                    visible: overlayers.visible,
                    objectIdField: 'objectId',
                    ...
                    popupEnabled: false,
                    popupTemplate: false,
                    isCluster: overlayers.style.isCluster,
                    clusterImgSrc: overlayers.style.clusterImgSrc,
                    defaultClusterSym: overlayers.style.defaultClusterSym,
                    // elevationInfo: (overlayers as OverlayGroup).elevationInfo,
                    maxScale: overlayers.maxScale,
                    minScale: overlayers.minScale,
                    fields: datafiled_5,
                ...
                _this.view.map.add(clientoperateLayer_2);
                overlayers.overlayers.forEach(function (overelement) {
                    var dataattributes = overelement.attributes;
                    dataattributes['uuid'] = overelement.uuid;
                    var graphic = new Graphic({
    ...
    Map.prototype.removefeatureCluster = function (overlayers) {
        var _this = this;
        if (overlayers instanceof Array) {
            overlayers.forEach(function (overelemnt) {
                var graphiclist = _this.mapoverlayersflayer.filter(function (item) {
    ...
    Map.prototype.init = function (container, viewMode, mapoptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                load(['82B44794-5CE0-A64A-9047F07CAF08BD2C/08F60FEF-C6FF-A788-344D-1755CB0E3870/xhrutils'])
                    // tslint:disable-next-line:no-shadowed-variable
                    .then(function (_a) {
                    var xhrutils = _a[0];
